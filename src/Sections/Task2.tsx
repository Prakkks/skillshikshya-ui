...
const Task2 = () => {
  return (
    <section className="w-full  p-10 sm:p-15 md:p-20 md:px-36 bg-white">
        ...
        <div className="relative mt-5 sm:mt-10 w-full   ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2  w-full gap-5  ">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2  w-full gap-5 absolute top-0 ">
